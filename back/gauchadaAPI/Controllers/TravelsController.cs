...
namespace gauchadaAPI.Controllers
{
    ...
    {
        private readonly TravelDbContextcs _context;

        public TravelsController(TravelDbContextcs context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Travel>> PostTravel(Travel travel)
        {
          if (_context.Travels == null)
          {
              return Problem("Entity set 'TravelDbContextcs.Travels'  is null.");
          }
